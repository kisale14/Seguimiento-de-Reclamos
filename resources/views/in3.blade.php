...
<head>
    ...
    <title>Actualización de Reclamos</title>
</head>
<body>
    <style>
        .main-image{
            position: relative;
            background: url("https://images.squarespace-cdn.com/content/v1/5fce32ec3775b77c105f1681/c26abeda-1080-4033-a80b-0e69025dde43/deep+A+1600+x+900.jpg") no-repeat center;
            margin-left: 150px;
            margin-right: 150px;
            margin-top: 50px;
        ...
        <div class="tbl_container">
            ...
            <table class="tbl">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$item->titulo}}</td>
                        <td>{{$item->concurrencia}}</td>
                        <td>{{$item->propietario_id}}</td>
                        <td>
                            <a href="{{route('quejas.destroy', $item->id)}}">
    ...
    <section class="contact" id="contact">
        <div class="contact__main">
            <div class="contact__main__description">
                <h2 class="contact__main__description__title">Actualización de Reclamo</h2>
            ...
            <form class="contact__main__form" action="{{route('reclamo.create')}}">
    
                <div class="contact__main__form__group">
                    <div class="contact__main__form__field">
                        <label for="name" class="contact__main__form__field__label">Titulo del Reclamo</label>
                        <input type="text" class="contact__main__form__field__input" name="titulo" id="name" placeholder="Titulo" required autocomplete="name">
                    </div>
        ...
        @enderror
                    ...
                    <div class="contact__main__form__field">
                        <label for="email" class="contact__main__form__field__label">Concurrencia</label>
                        <input type="text" class="contact__main__form__field__input" name="concurrencia" id="email" placeholder="Concurrencia" required>
                    </div>
                </div>
    
                <div class="contact__main__form__field">
                    <label for="message" class="contact__main__form__field__label">Descripción del Reclamo</label>
                    <textarea name="contenido" id="message" placeholder="Descripción" class="contact__main__form__field__input textarea" required></textarea>
                </div>

                <div class="contact__main__form__group">
                    <div class="contact__main__form__field">
                        <label for="nombre" class="contact__main__form__field__label">Gestor del Reclamo</label>
                         <select name="gestor" class="contact__main__form__field__input" id="">
